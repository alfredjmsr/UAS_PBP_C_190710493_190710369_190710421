...
public class TrainFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        builder = new AlertDialog.Builder(TrainFormActivity.this);
        ...
        orderCall.enqueue(new Callback<Order>() {
            ...
            public void onResponse(Call<Order> call, Response<Order> response) {
                if(response.isSuccessful()) {
                    ...
                    dialog.show();
                    if(!dialog.isShowing()){
                        Intent intent = new Intent(TrainFormActivity.this, FlightActivity.class);
                        startActivity(intent);
                    }
...
//                    canvas.drawText("Couvee Petshop", pageWidth / 2, 270, titlePaint);
        ...
        try {
            ...
            Toasty.success(TrainFormActivity.this, "Tiket anda telah di cetak", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(TrainFormActivity.this, FlightActivity.class);
            startActivity(intent);
